    ...
    <section className="bg-bg-secondary relative overflow-hidden">
      <div className="max-container flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="w-full lg:w-1/2 content-wrapper text-center lg:text-left">
          ...
          <div className="mt-16 hidden md:block opacity-40">
            <img 
              src="https://picsum.photos/seed/konick-contact/800/800" 
              alt="Contact Deco" 
              className="w-full max-w-[400px] h-auto rounded-[40px] grayscale hover:grayscale-0 transition-all duration-700 border border-white/5 shadow-2xl rotate-2"
